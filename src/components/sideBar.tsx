...
const SideBar: React.FC = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      >
        <div className=" flex items-center justify-between text-4xl font-extrabold mb-8 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent sm:ml-7 ">
